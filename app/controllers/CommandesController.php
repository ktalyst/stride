...
class CommandesController extends BaseController {
	...
	public function store()
	{
		...
		$input = array('commandeCode' => $code, 'contrat_id' => $contrat);
		...
		if ($validation->passes())
		{
			...
			{
				$input = array('itemCode' => $item['code'], 'itemLibelle' => $item['libelle'], 'commande_id' => $commande->id);
		...
		->with('message', Helper::notification('There were validation errors.','danger'));
	}
